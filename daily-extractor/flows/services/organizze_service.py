...
class OrganizzeService:
    def __init__(self, params: OrganizzeServiceParams) -> None:
        ...
        self.__auth = HTTPBasicAuth(username=params.get("username"), password=params.get("password"))
    ...
    def get_transactions(self, params: GetTransactionsParams):
        ...
        response = requests.get(f"{self.__base_url}/transactions", params=request_params, auth=self.__auth, headers=self.__headers)
